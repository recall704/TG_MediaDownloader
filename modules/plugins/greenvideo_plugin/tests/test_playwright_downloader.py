...
class TestSanitizeFilename(unittest.TestCase):
    ...
    def test_normal_filename(self):
        ...
        safe_name, truncated = self.downloader._sanitize_filename(
...
class TestExtractVideoWithInterceptionRetry(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_success_without_retry(self):
        ...
        with patch(
            "modules.plugins.greenvideo_plugin.playwright_downloader.async_playwright"
        ) as mock_playwright:
    ...
    async def test_retry_on_timeout(self):
        ...
        with patch(
            ...
            mock_playwright.return_value.__aenter__.return_value.chromium.launch.side_effect = mock_launch
